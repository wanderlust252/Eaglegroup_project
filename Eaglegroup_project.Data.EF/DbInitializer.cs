        ...
        public async Task Seed()
        {
            ...
            if (_context.Functions.Count() == 0)
            {
                _context.Functions.AddRange(new List<Function>()
                {
                    ...
                    //new Function() {Id = "BILL",Name = "Hóa đơn",ParentId = "PRODUCT",SorOrder = 3,Status = Status.InActive,URL = "/admin/bill/index",IconCss = "fa-chevron-down"  },
                    new Function() {Id = "CONTENT",Name = "Nội dung",ParentId = null,SortOrder = 3,Status = Status.InActive,URL = "/",IconCss = "fa-table"  },
                    new Function() {Id = "NEWS",Name = "Bài viết",ParentId = "CONTENT",SortOrder = 1,Status = Status.InActive,URL = "/admin/news/index",IconCss = "fa-table"  },
                    new Function() {Id = "CATEGORY",Name = "Danh mục",ParentId = "CONTENT",SortOrder = 2,Status = Status.InActive,URL = "/admin/category/index",IconCss = "fa-table"  },
                    new Function() {Id = "PAGE",Name = "Trang",ParentId = "CONTENT",SortOrder = 3,Status = Status.InActive,URL = "/admin/page/index",IconCss = "fa-table"  },
                    new Function() {Id = "UTILITY",Name = "Tiện ích",ParentId = null,SortOrder = 4,Status = Status.InActive,URL = "/",IconCss = "fa-clone"  },
                    ...
                    new Function() {Id = "ANNOUNCEMENT",Name = "Thông báo",ParentId = "UTILITY",SortOrder = 3,Status = Status.InActive,URL = "/admin/announcement/index",IconCss = "fa-clone"  },
                    ...
                    new Function() {Id = "ADVERTISMENT",Name = "Quảng cáo",ParentId = "UTILITY",SortOrder = 6,Status = Status.InActive,URL = "/admin/advertistment/index",IconCss = "fa-clone"  },
                    new Function() {Id = "VIDEO",Name = "Video",ParentId = "UTILITY",SortOrder = 7,Status = Status.InActive,URL = "/admin/video/index",IconCss = "fa-clone"  },
